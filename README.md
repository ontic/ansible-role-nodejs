# Ontic Node.js ![Status](https://img.shields.io/badge/project-maintained-brightgreen.svg)

| Branch             | Build               | Galaxy              | Release              |
| :----------------- | :------------------ | :------------------ | :------------------- |
| **master**         | [![Build](https://img.shields.io/travis/ontic/ansible-role-nodejs/master.svg)](https://travis-ci.org/ontic/ansible-role-nodejs) | [![Galaxy](https://img.shields.io/badge/galaxy-ontic.nodejs-blue.svg)](https://galaxy.ansible.com/ontic/nodejs) | [![Release](https://img.shields.io/github/release/ontic/ansible-role-nodejs.svg)](https://github.com/ontic/ansible-role-nodejs/releases) |

## Introduction

This role installs Node.js on RedHat/CentOS and Debian/Ubuntu Linux servers.
...
```
$ ansible-galaxy install ontic.nodejs
```
...
```yml
- src: git+https://github.com/ontic/ansible-role-nodejs.git
  version: master
  name: ontic.nodejs
```
